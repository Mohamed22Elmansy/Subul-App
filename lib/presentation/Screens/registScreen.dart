                ...
                builder: (context, state) {
                  return SizedBox(
                    ...
                    child: TextFielld(
                      ...
                      obscureText:
                          BlocProvider.of<LoginPageCubit>(context).passVisible,
                      ...
                      Row(
                        children: [
                          Radio<Gender>(
                              value: Gender.male,
                              groupValue:
                                  BlocProvider.of<RegistCubit>(context).gender,
                    ...
                    builder: (context, state) {
                      return Builder(builder: (ctx) {
                        return ElevatedButton(
                          onPressed: () {
                            if (BlocProvider.of<RegistCubit>(context).gender ==
                                null) {
                              showDialog(
                                  context: context,
                              ...
                              BlocProvider.of<RegistCubit>(context).regist(
                                  ...
                                  gender: BlocProvider.of<RegistCubit>(context)
                                      .userGender!,
                                  context: context,
